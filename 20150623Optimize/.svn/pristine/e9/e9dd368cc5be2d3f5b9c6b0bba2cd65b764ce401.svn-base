<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shopdiscountlist.aspx.cs" Inherits="CompanyPages_shopdiscountlist" %>
<!DOCTYPE html>
...
<div>
    ...
    <div class="header">
        <div class="headerSprite">
            <div class="text">
				<h2 class="headerTitle shopdiscounttxt">折扣信息</h2>
    ...
    <div class="section">
        <div class="dataContainer shopdiscountlist">
            <p class="disBtn companyAccountTopBtn" id="addSprite">
                <a class="btn add" href="companyManage.aspx?type=shopdiscountlist&m=add&status=1&syid=0&vid=0">新增折扣</a>
            ...
            <div class="dataSprite">
				<div class="dataTable" id="dataTable">
					<table class="staticTable" cellpadding="0" cellspacing="0" border="0">
						<thead>
							<tr>
								<th class="">折扣名称</th><th class="">折扣率</th><th class="">平台等级</th><th class="yui3-datatable-col-btn">操作</th>
							</tr>
						</thead>
						<tbody>
						</tbody>
