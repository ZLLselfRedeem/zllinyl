<%@ Page Language="C#" AutoEventWireup="true" CodeFile="classicCaseManage.aspx.cs"
    Inherits="ViewAllocWebSite_CorpManage_classicCaseManage" %>

<%@ Register Src="~/web/CorpManage/ManageMenu.ascx" TagPrefix="Manage" TagName="ManageMenu" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>精选成功案例管理</title>
                    ...
                    <td>
                        <table cellspacing="0" cellpadding="5" width="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff"
                            ...
                            <tr>
                                <td>
                                    精选成功案例管理
                                    <input value="新增" onclick="return window.location.href='classicCaseMaintain.aspx'"
                                        id="add" type="button" class="button" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:GridView runat="server" ID="gvCase" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="商户名称" DataField="title"></asp:BoundField>
                                            <asp:BoundField HeaderText="序号(降序)" DataField="sequence" />
                                            <asp:TemplateField HeaderText="商户图片">
                                                <ItemTemplate>
                                                    <img src='<%# Eval("content")%>' alt="" width="80" height="60" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
