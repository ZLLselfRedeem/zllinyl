<%@ Page Language="C#" AutoEventWireup="true" CodeFile="uxianComplaintHandling.aspx.cs" Inherits="WeChatPlatManage_uxianComplaintHandling" %>
...
<body>
    ...
    <div>
        <asp:UpdatePanel ID="update1" runat="server">
            <ContentTemplate>
            <asp:ScriptManager ID="scManag1" runat="server"></asp:ScriptManager>
        ...
        <div class="div_gridview">
            <asp:Panel ID="Panel_Handling" runat="server">
                <asp:Label ID="lblInfo" Text="投诉信息" runat="server" CssClass="tabButtonBlueUnClick"></asp:Label>
                <hr size="1" style="border: none; border-bottom: 1px silver dotted;" />
                
                <asp:GridView ID="GridView_Handling" runat="server" DataKeyNames="ID,msgContent,contentType,senderWechatID,voicefileName,receiveDateTime,operater,operateDateTime,status"
                    AutoGenerateColumns="False" SkinID="gridviewSkin" 
                    ondatabound="GridView_Handling_DataBound">
                    <Columns>
                        <asp:BoundField DataField="ID" HeaderText="序号" />
                        <asp:BoundField DataField="msgContent" HeaderText="内容" />
                        ...
                        <%--<asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnDown" runat="server" CausesValidation="False"
                                    CommandName="Accept" Text="收听"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:TemplateField ShowHeader="false">
                            <ItemTemplate>
