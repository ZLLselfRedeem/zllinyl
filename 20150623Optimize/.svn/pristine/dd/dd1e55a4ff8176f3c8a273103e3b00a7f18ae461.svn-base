<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConsumeAndRechargeStatistic.aspx.cs"
    Inherits="ClientRecharge_ConsumeAndRechargeStatistic" %>
...
<body>
    ...
    <uc2:HeadControl ID="HeadControl1" runat="server" navigationImage="~/images/icon/list.gif"
        navigationText="用户充值及消费统计" navigationUrl="" headName="用户充值及消费统计" />
                ...
                <div class="div_gridview">
                    <asp:GridView runat="server" ID="gdvRechageList" AutoGenerateColumns="False" CssClass="gridview"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="rechargeCount" HeaderText="累计充值次数" />
                            <asp:BoundField DataField="rechargeAmount" HeaderText="累计充值金额" />
                            <asp:BoundField DataField="preOrderTotalQuantity" HeaderText="累计消费次数" />
                            <asp:BoundField DataField="preOrderTotalAmount" HeaderText="累计消费金额" />
                            <asp:TemplateField>
                                <ItemTemplate>
                    ...
                    <div>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lbConsumeCount" runat="server" Text="0" ForeColor="#F40404" Font-Bold="True"></asp:Label>
                                </td>
                                <th>
                                    次
                                </th>
                                ...
                                <td>
                                    <asp:Label ID="lbConsumeAmount" runat="server" Text="0" ForeColor="#F40404" Font-Bold="True"></asp:Label>
                                </td>
                                <th>
                                    元
                                </th>
