<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IntegrationRuleManage.aspx.cs"
    Inherits="Integration_IntegrationRuleManage" %>
...
<body>
    <form id="form1" autocomplete="off" runat="server">
        <uc3:HeadControl ID="HeadControl1" runat="server" navigationImage="~/images/icon/list.gif"
            navigationText="积分规则维护" navigationUrl="" headName="积分规则维护" />
            <div class="content">
                    <div style="width: 80%">
                        <table class="table" cellpadding="0" cellspacing="0" style="width: 100%">
                            <tr>
                                ...
                                <td>
                                   <asp:DropDownList ID="ddlBussnessEventType" runat="server">
                                   </asp:DropDownList>
                                </td>
                                <td colspan="2" align="center">
                                <asp:Button Width="130px" Height="33px" CssClass="couponButtonSubmit" ID="btnSearch" runat="server" Text="查询"
                                     OnClick="btnSearch_Click" />
                                &nbsp;
                                <asp:Button Width="130px" Height="33px" CssClass="couponButtonSubmit" ID="btnNew" runat="server" Text="新建规则"
                            ...
                            <tr>
                                <td colspan="3">
                                     <div class="div_gridview" id="div_gridview">
                                          <asp:GridView ID="gdList" runat="server" Width="100%" DataKeyNames="ID,RuleTypeName,Description,Integration,EventType,EventComplement,ConditionalMinValue,ConditionalMaxValue,Status"
                AllowSorting="True" AutoGenerateColumns="False" SkinID="gridviewSkin" OnRowCommand="gdList_RowCommand">
                <Columns>
                    <asp:BoundField DataField="RuleTypeName" HeaderText="业务事件类型" />
                    <asp:BoundField DataField="Description" HeaderText="业务事件描述"/>
                    <asp:BoundField DataField="Integration" HeaderText="积分值"/>
                    <asp:BoundField DataField="EventType" HeaderText="事件类型"/>
                    <asp:BoundField DataField="EventComplement" HeaderText="事件补充"/>
                    <asp:BoundField DataField="Status" HeaderText="启停状态"/>
                    <asp:TemplateField HeaderText="操作" HeaderStyle-HorizontalAlign="Center" ItemStyle-Wrap="false">
                        <ItemTemplate>
                            <asp:LinkButton runat="server" CommandName="update" ID="lbtnUpdate">编辑</asp:LinkButton>&nbsp;<asp:LinkButton runat="server" OnClientClick="return confirm('你确定删除吗？')" CommandName="del" ID="lbtnDelete">删除</asp:LinkButton>
                        </ItemTemplate>
