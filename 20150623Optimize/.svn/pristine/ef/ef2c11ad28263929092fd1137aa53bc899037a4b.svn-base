<%@ Page Language="C#" AutoEventWireup="true" CodeFile="comprehensiveStatistics.aspx.cs"
    Inherits="StatisticalStatement_comprehensiveStatistics" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div class="QueryTerms">
                ...
                <asp:Panel ID="Panel_OrderStatistics_Table" runat="server">
                    ...
                    <table>
                        <tr>
                            <td style="vertical-align: middle">统计就餐时段：
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Button ID="Button_afternoon" runat="server" CssClass="tabButtonBlueUnClick"
                                    CommandName="afternoon" OnClick="Button_allDay_Click" Text="下午(14~17时)" Width="120px"></asp:Button>
                            </td>
                            <td>
                                <asp:Button ID="Button_night_soon" runat="server" CssClass="tabButtonBlueUnClick"
                                    CommandName="night_soon" OnClick="Button_allDay_Click" Width="120px" Text="晚市(16时~22时) "></asp:Button>
                            </td>
                            <td>
        ...
        <div class="div_gridview" id="div_gridview">
            <asp:GridView ID="GridView_OrderStatistics" runat="server" DataKeyNames="orderTime,orderCount,orderSumAmount,orderTransaction,isPaidOrderCount,isPaidOrderAmount,isPaidOrderTransaction,payRate"
                ...
                OnSorting="GridView_Sorting" OnRowDataBound="GridView_OrderStatistics_RowDataBound">
                <Columns>
                    <asp:BoundField DataField="orderTime" HeaderText="日期" SortExpression="orderTime" />
                    <asp:BoundField DataField="orderCount" HeaderText="订单笔数" SortExpression="orderCount" />
                    <asp:BoundField DataField="orderSumAmount" HeaderText="订单总金额(元)" SortExpression="orderSumAmount" />
                    <asp:BoundField DataField="orderTransaction" HeaderText="订单客单价" SortExpression="orderTransaction" />
                    <asp:BoundField DataField="isPaidOrderCount" HeaderText="支付笔数" SortExpression="isPaidOrderCount" />
                    <asp:BoundField DataField="isPaidOrderAmount" HeaderText="支付总金额(元)" SortExpression="isPaidOrderAmount" />
                    <asp:BoundField DataField="isPaidOrderTransaction" HeaderText="支付客单价(元)" SortExpression="isPaidOrderTransaction" />
