<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomeSubTitleAdd.aspx.cs" Inherits="HomeNew_HomeTitleAdd" %>
                ...
                <div class="layout">
                    <table class="table" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="TextTitleName" runat="server" Width="155px"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlRule" runat="server" Width="155px"></asp:DropDownList>
                            </td>
                        </tr>
                        <%--<tr>
                        <th>
