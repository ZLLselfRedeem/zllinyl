<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateHistoryMaintain.aspx.cs"
    Inherits="ViewAllocWebSite_CorpManage_updateHistoryMaintain" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Cancel() {
            ...
            this.document.getElementById("txtVersion").value = "";
                    ...
                    <td>
                        <table cellspacing="0" cellpadding="5" width="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtVersion"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" ID="rfvVersion" ControlToValidate="txtVersion"
                                        Text="必填" ForeColor="Red"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="rfvContene" ControlToValidate="txtTitle"
                                        Text="必填" ForeColor="Red"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    ...
                                    <input id="btnBack" type="button" value="返回" causesvalidation="false" onclick="return window.location.href='updateHistoryManage.aspx'" />
                                </td>
                            </tr>
                        </table>
                    </td>
