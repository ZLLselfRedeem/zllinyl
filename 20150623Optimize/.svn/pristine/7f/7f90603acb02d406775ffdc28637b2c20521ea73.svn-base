<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreOrderShopConfirmed.aspx.cs"
    Inherits="PreOrder19dianManage_PreOrderShopConfirmed" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#mainFrame").css({ "height": layoutHeight });
        });  
            ...
            <div class="layout">
                <div class="QueryTerms">
                    ...
                    <table cellspacing="5">
                        <tr>
                            <td>
                                <asp:Button ID="Button_UnApproved" runat="server" Text="未入座" CssClass="tabButtonBlueUnClick"
                                    OnClick="Button_Approved_Click" CommandName="n" />
                            </td>
                            <td>
                                <asp:Button ID="Button_Approved" runat="server" Text="已入座" CssClass="tabButtonBlueUnClick"
                ...
                <asp:Panel ID="Panel_PreOrder19dian" runat="server" CssClass="div_gridview">
                    <asp:GridView ID="GridView_PreOrderShopVerified" runat="server" DataKeyNames="preOrder19dianId,isApproved"
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="Button_Verified" runat="server" CausesValidation="False" CommandName="Verified"
                                        Text="入座" CssClass="linkButtonDetail"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                ...
                <asp:Panel ID="Panel_Detail" runat="server" CssClass="div_gridview" Visible="false">
                    <div class="divDetailTitle" style="overflow-y: hidden">
                        ...
                        <label>
                            点单详情信息</label><asp:Button ID="Button_ShopConfirmed" runat="server" Text="" CssClass="couponButtonSubmit"
