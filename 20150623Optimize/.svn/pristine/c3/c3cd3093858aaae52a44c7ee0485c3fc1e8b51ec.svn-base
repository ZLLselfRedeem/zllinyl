<%@ Page Language="C#" AutoEventWireup="true" CodeFile="recentNewsManage.aspx.cs"
    Inherits="ViewAllocWebSite_CorpManage_recentNewsManage" %>
                    ...
                    <td>
                        <table cellspacing="0" cellpadding="5" width="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff"
                            ...
                            <tr>
                                <td>
                                    最新动态管理
                                    <input value="新增" onclick="return window.location.href='recentNewsMaintain.aspx'"
                                        id="add" type="button" class="button" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:GridView runat="server" ID="gvRecentNews" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="类别" DataField="remark" />
