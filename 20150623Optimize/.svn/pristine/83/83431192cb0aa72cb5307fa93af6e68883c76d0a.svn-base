...
public partial class OtherStatisticalStatement_singleShopDayOrderList : System.Web.UI.Page
{
    ...
    protected void GR_BindData(int str, int end)
    {
        ...
        Label_refundAmount.Text = Common.ToDouble(dt.Compute("sum(refundOrderCount)", "1=1")).ToString("0.00");
        Label_refundCount.Text = dt.Compute("sum(refundOrderAmount)", "1=1").ToString();
        #endregion
        if (dt.Rows.Count > 0)
        {
