<%@ Page Language="C#" AutoEventWireup="true" CodeFile="uxianCooperation.aspx.cs" Inherits="WeChatPlatManage_uxianCooperation" %>
...
<body>
    ...
    <div>
        <asp:UpdatePanel ID="update1" runat="server">
            <ContentTemplate>
                <asp:ScriptManager ID="scMa1" runat="server"></asp:ScriptManager>
                <asp:Panel ID="Panel_CustomerDetail" runat="server">
                    <div class="div_gridview" id="div_gridview" style="border-bottom: 2px solid #507CD1;">
                        <asp:GridView ID="GridView_Info" runat="server" DataKeyNames="ID,msgContent,pubDateTime,UserName"
                            AutoGenerateColumns="False" SkinID="gridviewSkin" OnRowDeleting="GridView_Info_RowDeleting">
                            <Columns>
        ...
        <asp:Panel ID="Panel_MemberStatisticGridview" runat="server">
            <div class="div_gridview" id="div_othergridview">
                ...
                <asp:UpdatePanel ID="udate2" runat="server">
                    <ContentTemplate>
        ...
        <div class="div_gridview">
            <asp:Panel ID="Panel_Coop" runat="server">
                <asp:Label ID="lblInfo" Text="商户合作信息" runat="server" CssClass="tabButtonBlueUnClick"></asp:Label>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="Button_Query" runat="server" Text="查     询" CssClass="tabButtonBlueClick" />
                    </td>
                </tr>
                </table>--%>
                <asp:GridView ID="GridView_CoopInfo" runat="server" DataKeyNames="ID,msgContent,senderWechatID,receiveDateTime,operater,operateDateTime,status"
                    AutoGenerateColumns="False" SkinID="gridviewSkin" 
                    ondatabound="GridView_CoopInfo_DataBound">
                    <Columns>
                        <asp:BoundField DataField="ID" HeaderText="序号" />
                        <asp:BoundField DataField="msgContent" HeaderText="内容" />
                        ...
                        <asp:TemplateField ShowHeader="false">
                            <ItemTemplate>
                                ...
                                <asp:CheckBox ID="chkChecked" runat="server" Text="已处理" AutoPostBack="True" OnCheckedChanged="chkChecked_CheckedChanged" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                ...
                <asp:Label ID="Label_MerchantNodata" runat="server" CssClass="Red" Text=""></asp:Label>
            </asp:Panel>
        </div>
    </div>
    </form>
