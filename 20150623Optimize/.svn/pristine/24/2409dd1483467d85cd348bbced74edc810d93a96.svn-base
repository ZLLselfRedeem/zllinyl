<%@ Page Language="C#" AutoEventWireup="true" CodeFile="preOrderConfirmedDetail.aspx.cs" Inherits="CompanyPages_preOrderConfirmedDetail" %>
<!DOCTYPE html>
<title>悠先收银宝平台-收银审核详情</title>
<body>
<div>
    ...
    <div class="section nyPage">
        <div class="showList" id="showList">
			...
			<a class="bar" href="javascript:;"> 
				更多信息(收起\展开)<span class="arrow">&nbsp;</span>
		    </a>
        </div>
        <div class="comment" id="comment">
            ...
            <div class="btnSprite">
                <a class="btn cancel operate" href="javascript:;"></a><a class="btn back" href="preOrderShopConfirmed.aspx">返回</a>
				<div id="popupSprite"></div>
            </div>
        </div>
    </div>
