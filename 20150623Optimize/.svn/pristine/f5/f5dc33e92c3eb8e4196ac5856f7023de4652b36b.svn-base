...
namespace CloudStorage
{
    ...
    public class AliyunOpenStorageService
    {
        ...
        /// <returns></returns>
        public AliyunOSSResult PutObject(string objectKey, Stream content)
        {
            AliyunOSSResult result = new AliyunOSSResult();
            OssClient ossClient = CreateOssClient();
            try
            {
                ...
                string extension = System.IO.Path.GetExtension(objectKey);
                switch (extension.ToLower())
                {
                    case ".bmp":
                        metadata.ContentType = "application/x-bmp";
                        break;
                    case ".exe":
                        metadata.ContentType = "application/x-msdownload";
                        break;
                    case ".gif":
                        metadata.ContentType = "image/gif";
                        break;
                    case ".ico":
                        metadata.ContentType = "image/x-icon";
                        break;
                    case ".jpg":
