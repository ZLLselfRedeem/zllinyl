<%@ Page Language="C#" AutoEventWireup="true" CodeFile="preOrderVerifiedDetail.aspx.cs" Inherits="CompanyPages_preOrderVerifiedDetail" %>
<!DOCTYPE html>
...
<div>
    ...
    <div class="section nyPage">
        ...
        <div class="comment" id="comment">
            ...
            <div class="btnSprite">
                <!--<a class="btn cancel operate" href="javascript:;"></a>--><a class="btn back" href="preOrderShopVerified.aspx">返回</a>
            </div>
        </div>
    </div>
