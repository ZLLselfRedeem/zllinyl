            ...
            <div class="layout">
                <table class="table" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox_cityName" runat="server" Width="155px" ReadOnly="True" enable="false" BorderStyle="None"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style=" text-align:right; background-color: #C9E7FF;">
                        ...
                        <td>
                            <asp:TextBox ID="TextOrder" runat="server" Width="155px"  onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style=" text-align:right; background-color: #C9E7FF;">
