<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FoodDiariesApp.aspx.cs" Inherits="AppPages_FoodDiariesApp" %>
...
<body>
    ...
    <div class="food-diaries-show" id="diariesShow" data-role="page" data-module="module-main"
        data-channel="channel-main" data-title="" >
    ...
    <script type="text/javascript">
        $(function () {
            var pageType = "app";
            var queryString = GetRequestParam("app");
            if (queryString != undefined && queryString != "undefined" && queryString == "true") {
                setFooderHtml(pageType, "true");
            }
            else {
