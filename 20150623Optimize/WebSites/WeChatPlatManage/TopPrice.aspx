<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TopPrice.aspx.cs" Inherits="WeChatPlatManage_TopPrice" %>
...
<body>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="Panel_CustomerDetail" runat="server">
                <div class="div_gridview" id="div_gridview">
                    <asp:GridView ID="GridView_TopPrice" runat="server" DataKeyNames="ID,msgContent,pubDateTime,operaterID,Status"
                        AutoGenerateColumns="False" SkinID="gridviewSkin" 
                        onrowdeleting="GridView_TopPrice_RowDeleting">
                        <Columns>
        ...
        <asp:Panel ID="Panel_MemberStatisticGridview" runat="server">
            <div class="div_gridview" id="div_othergridview">
                    ...
                    <ContentTemplate>
                        <table id="tbUpdate" style="display:none; border: 1px solid silver;" runat="server">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="validSet" Text="是否过期" CausesValidation="false" runat="server" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
                ...
                <div class="divDetailTitle" style="overflow-y: hidden">
                    ...
                    <asp:Button ID="Button_Save" runat="server" Text="新    增" CssClass="couponButtonSubmit" onclick="Button_Save_Click" />&nbsp;&nbsp;
    ...
    <div class="div_gridview">
        <asp:Label ID="lblVIP" Text="VIP信息" runat="server" CssClass="tabButtonBlueUnClick"></asp:Label>
        ...
        <table style="border: 1px solid silver;">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtVipCardNo" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:Button ID="Button_QueryByeCardNum" runat="server" Text="查     询" 
                        CssClass="tabButtonBlueClick" onclick="Button_QueryByeCardNum_Click" />
                </td>
            </tr>
        </table>
        <asp:GridView ID="GridView_VIP" runat="server" DataKeyNames="eCardNumber,mobilePhoneNumber,customerEmail,wechatId,cityName"
            AutoGenerateColumns="False" SkinID="gridviewSkin">
            <Columns>
                <asp:BoundField DataField="eCardNumber" HeaderText="卡号" />
                <asp:BoundField DataField="mobilePhoneNumber" HeaderText="联系方式" />
                <asp:BoundField DataField="customerEmail" HeaderText="邮箱" />
                <asp:BoundField DataField="wechatId" HeaderText="微信号" />
                <asp:BoundField DataField="cityName" HeaderText="城市" />
            </Columns>
        </asp:GridView>
        <asp:Label ID="Label_noData" runat="server" CssClass="Red" Text=""></asp:Label>
        </ContentTemplate>
        </asp:UpdatePanel>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        TabManage();
        GridViewStyle("GridView_TopPrice", "gv_OverRow");
