<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShopAmountStatistics.aspx.cs"
    Inherits="StatisticalStatement_ShopAmountStatistics" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div class="QueryTerms">
                城市：<asp:DropDownList ID="ddlCity" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCity_SelectedIndexChanged"></asp:DropDownList>
            ...
            <asp:Panel ID="Panel_DayShopStatistics" runat="server">
                <div class="div_gridview" id="div_gridview">
                    <asp:GridView ID="GridView_DayShopsStatistics" runat="server" DataKeyNames="dayTime"
                        AutoGenerateColumns="False" SkinID="gridviewSkin">
                        <Columns>
                            <asp:BoundField DataField="dayTime" HeaderText="日期" />
                            <asp:BoundField DataField="shopCount" HeaderText="新增门店数" />
                            <asp:BoundField DataField="totalShopCount" HeaderText="累计门店数" />
                        </Columns>
                    </asp:GridView>
                    <div class="asp_page">
